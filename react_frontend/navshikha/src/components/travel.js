...
const stories = [{
    ...
    'bg': pune1,
    'paragraphs': {
        'intro': 'Being tired of the normal routine, we decided to go out for a short weekend outing to the city of Pune. Honestly, initially, I always used to think Pune was too overrated. However, my opinion was about to change.',
        'details': [
